...
template<typename T>
__global__ void 
ConvertWeightToInv(T* dst, const T* src, const size_t data_size)
{
...
template void invokeConvertWeightToInv<float>(float* dst, const float* src, const size_t data_size, cudaStream_t stream);
