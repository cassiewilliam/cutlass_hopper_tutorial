...
struct CollectiveBuilder<
    ...
    KernelScheduleType,
    cute::enable_if_t<
      (cute::is_same_v<KernelScheduleType,  KernelPtrArrayTmaWarpSpecializedCooperativeBlockScaling>) && 
...
private:
  ...
  static constexpr bool IsArrayOfPointersGemm = cute::is_any_of_v<KernelScheduleType,
                                                                  KernelPtrArrayTmaWarpSpecializedCooperativeBlockScaling,
                                                                  KernelPtrArrayTmaWarpSpecializedPingpong>;

//   static constexpr bool IsArrayOfPointersGemm = true;
...
public:
  ...
  using DispatchPolicy = cute::conditional_t<IsMixedInput,
      cute::conditional_t<IsArrayOfPointersGemm,
        MainloopSm90ArrayTmaGmmaWarpSpecializedMixedInputBlockScaling<PipelineStages, ClusterShape_MNK, KernelScheduleType>, 
